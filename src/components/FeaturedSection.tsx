...
const FeaturedSection = () => {
  ...
  return (
    <section className="py-20 px-4 sm:px-8 bg-[#FFD400]" ref={ref}>
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
        {features.map((feature, idx) => (
          <motion.div
            ...
            className="bg-white rounded-[12px] shadow-md text-left p-4"
          >
            <div className="w-full h-[300px] overflow-hidden rounded-[12px] mb-4">
              <img
                src={feature.image}
                alt={feature.title}
