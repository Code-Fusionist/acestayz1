...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="relative min-h-screen bg-white overflow-x-hidden">
      ...
      <section className="bg-white text-gray-800 px-6 md:px-20 py-24">
        <motion.div
        ...
        >
          ...
          <div className="space-y-6 leading-relaxed text-base md:text-lg">
            ...
            <h2 className="text-xl font-semibold text-ace-gold">Collection of Data</h2>
            ...
            <h2 className="text-xl font-semibold text-ace-gold">Usage of Your Information</h2>
            <ul className="list-disc pl-6">
            ...
            <h2 className="text-xl font-semibold text-ace-gold">Non-disclosure to Third Parties</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-ace-gold">Cookies</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-ace-gold">Security</h2>
            <p>
              We implement strict procedures to protect your information. Credit
              card data is never stored on our website.
            </p>

            <h2 className="text-xl font-semibold text-ace-gold">Your Consent</h2>
            <p>
              By using our services, you consent to this privacy policy. Any
              updates will be posted on this page.
            </p>

            <h2 className="text-xl font-semibold text-ace-gold">Opt-Out & Data Access</h2>
            <p>
